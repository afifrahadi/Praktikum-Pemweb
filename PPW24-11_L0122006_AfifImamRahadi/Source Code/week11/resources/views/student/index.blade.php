            ...
            <tr align=center bgcolor = #FFDAB9>
                ...
                <td>
                    <button type="button" class="btn btn-primary btn-sm">
                        <a href="students/edit/{{$student->id}}" class="text-light" style="text-decoration: none;">
                            Edit
                        </a>
                    </button>
                    <button type="button" class="btn btn-primary btn-sm" onclick="return confirm('Hapus data atas nama {{$student->nama}}?')" >
                        <a href="students/delete/{{$student->id}}" class="text-light" style="text-decoration: none;">
                            Delete
                        </a>
                    </button>
                </td>
